  ...
  return (
    ...
    >
      ...
      <Stack gap={4} sx={{ width: "334px" }}>
        <Input label="Нэр" placeholder="" helperText="" />
        <Input placeholder="" label="Имэйл хаяг" helperText="" />
        <Input label="Нууц үг" placeholder="" helperText="" />
        <Input label="Нууц үг давтах " placeholder="" helperText="" />
